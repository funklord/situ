...
repository has this today: `test/schema/header.situ`, `example/message/` and
`example/packet/` each declare a `Header`, all three generate into one
directory, and `test/generated/Makefile` works around the clash by never
