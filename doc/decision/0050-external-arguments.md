...
(26.386). Still to do: the four backends' view constructor, the
walker's `acquire`, the dissector's preference, `situ verify`'s
argument, and the wire and map naming -- and a corpus struct, which
lands with the backends rather than before them
Date: 2026-09-04
