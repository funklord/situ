...
SUFFIXES = frozenset({
	...
	# them the same way.
	"compute", "check",
	# A scaled text number's value is two numbers, so a member named x makes
	# x_significand and x_exponent beside the fallible x (0056). A schema
	# field of either name would collide the same way x_len does.
