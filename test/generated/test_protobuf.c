 ...
 * test/unit/test_protobuf.py; this one checks that situ's description of the
 ...
 *
 *   printf '...' | protoc --encode=User example/protobuf/user.proto
 *
 * and is reproduced verbatim. example/protobuf/vectors.txt records the input
 ...
 * from example/protobuf/protobuf.situ. It used to walk them through a cursor
