...
def test_the_committed_example_imports_to_the_same_shape() -> None:
	"""`examples/protobuf/` was written by hand from `user.proto`.
	...
	"""
	source = (ROOT / "examples" / "protobuf" / "user.proto").read_text(
		encoding="ascii")
	generated = translated(source, "user.proto")
	committed = (ROOT / "examples" / "protobuf" / "protobuf.situ").read_text(
		encoding="ascii")
